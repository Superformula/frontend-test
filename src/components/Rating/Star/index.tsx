...
import { Tag, Border, Half } from './styles'

const Star: React.FunctionComponent = () => (
  <Tag viewBox="0 0 20 20" fill="none" data-testid="rating-star">
    ...
    <g mask="url(#mask0)">
    <Half width="10" height="20" fill="transparent"/>
    </g>
  </Tag>
)
